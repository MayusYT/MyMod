...
public class TileGenerator extends TileEntity implements ITickable, IRestorableTileEntity, IGuiTile {
    ...
    public void invalidate() {
        super.invalidate();
        mcjty.mymod.generator.DamageTracker.instance.remove(world.provider.getDimension(), pos);
    }
    ...
    private void findEntities() {
        mcjty.mymod.generator.DamageTracker.instance.clear(world.provider.getDimension(), pos);

        List<EntityLivingBase> entities = world.getEntitiesWithinAABB(EntityLivingBase.class, getTrackingBox());
        for (EntityLivingBase entity : entities) {
            mcjty.mymod.generator.DamageTracker.instance.register(world.provider.getDimension(), pos, entity.getUniqueID());
        }
    }
